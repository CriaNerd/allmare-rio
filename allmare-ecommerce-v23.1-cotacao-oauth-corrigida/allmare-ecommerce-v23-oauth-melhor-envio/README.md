# Allmare Ecommerce V23.1 — OAuth automático do Melhor Envio
...
- Cotação corrigida para usar o token OAuth conectado no admin, sem depender da variável antiga `MELHOR_ENVIO_TOKEN`.
